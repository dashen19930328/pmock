...
var vm = new Vue({
    ...
    methods: {
        ...
        getInfo: function(id){
            $.get("/caseConfig/info/"+id, function(r){
                console.info("r="+r);
        ...
        saveOrUpdate: function () {
            var url = (vm.caseConfig.id == null || vm.caseConfig.id == '') ? "/caseConfig/save" : "/caseConfig/edit";
        ...
        getCaseMethod: function () {
            var url =  "/caseConfig/getCaseMethod";
            var caseText =  vm.aceEdtiorObject.aceEditor.getValue();
            vm.caseConfig.caseText=caseText;
            $.ajax({
                type: "POST",
        ...
        runCaseMethod: function () {
            var url =  "/caseConfig/runCaseMethod";
            var caseText =  vm.aceEdtiorObject.aceEditor.getValue();
            vm.caseConfig.caseText=caseText;
